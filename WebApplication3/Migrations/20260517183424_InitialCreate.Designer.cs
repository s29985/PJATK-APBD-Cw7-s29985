...
namespace WebApplication3.Migrations
{
    ...
    [Migration("20260517183424_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication3.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("WebApplication3.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication3.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication3.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication3.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication3.Models.Component", b =>
                {
                    b.HasOne("WebApplication3.Models.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication3.Models.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("WebApplication3.Models.PCComponent", b =>
                {
                    b.HasOne("WebApplication3.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication3.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
